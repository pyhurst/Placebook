  ...
  return (
    <div id="Signup" className="container">
      ...
      <form>
        ...
        <input type="text" name="address" id="addressInput" ref={addressRef} />
        <label for="city">City: </label>
        <input type="text" name="city" id="cityInput" ref={cityRef} />
        <label for="phone">Phone Number: </label>
        <input type="text" name="phone" id="phoneInput" ref={phoneRef} />
        ...
        <DropdownEl
          ...
          ref={openTimeRef}
        />
        <input type="text" name="address" id="addressInput" ref={openTimeRef} />
        ...
        <input
          ...
          ref={closeTimeRef}
        />
        <label for="timeSlotLength">
          Length of Timeslots (in 30 minute increments):{" "}
        </label>
        <input
          type="number"
          name="timeSlotLength"
